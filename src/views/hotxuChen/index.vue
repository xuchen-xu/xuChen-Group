<template>
  <div class="app-container">
    ...
    <router-link to="/productxuchen/newhot">
...
<script>
import { getProductListHot, deleteProductHot } from "@/api/productself";
import Pagination from "@/components/Pagination";
import { data as dataorigin } from "../../../mock/hotXuchen";
...
export default {
  ...
  methods: {
    async getProList() {
      ...
      const result = await getProductListHot(this.listQuery);
    ...
    async handleDelete(index, row) {
      ...
      const result = await deleteProductHot({ id: row.id });
    ...
    handleEdit(index, row) {
      this.$router.push({ path: "/productxuchen/edithot/", query: { id: row.id } });
      console.log(row.id);
    }
  },
  components: {
